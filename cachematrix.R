...
## cacheSolve retrieves the inverse of a matrix if it's in memory or computes and shows the inverse
...
## note: this will try to load corpcor library and if it's not installed will try to install the library
...
cacheSolve <- function(X, ...){
  ...
  message("inverse is not in memory. Computing the inverse (if exists)")
  data <- X$get()
